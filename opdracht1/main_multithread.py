'''
Run with 
'python3 main_multithread.py | tee -a  output_multiprocessing.txt'
...
def doFold(fold):
	...
	#file.write("Start fold" + str(fold))
	...
	#file.write("errors on train set: " + str(naive_errors_train[fold, 0]) + ' ' + str(naive_errors_train[fold, 1]) + ' ' + str(naive_errors_train[fold, 2]))
	#file.write("errors on test set: " + str(naive_errors_test[fold, 0]) + ' ' + str(naive_errors_test[fold, 1]) + ' ' + str(naive_errors_test[fold, 2]))
	...
	#file.write("Linear Regression done. Coefficients: " + str(regr_coeffs) + ' ' + str(regr_intercept))
	#file.write("Training error: " + str(regr_error_train))
	#file.write("Test error: " + str(regr_error_test))
	...
	#file.write('MF training set error: ' + str(MF_error_train))
	#file.write('MF test set error: ' + str(MF_error_test))
